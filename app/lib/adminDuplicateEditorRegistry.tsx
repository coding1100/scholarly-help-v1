...
const DUPLICATE_EDITOR_BY_SOURCE_PATH: Record<string, ComponentType> = {
  ...
  "/admin/take-my-class-protect-gpa": TakeMyClassAdmin,
  "/admin/take-my-class-always-working-harder": TakeMyClassAdmin,
  "/admin/take-my-class-saving-your-future": TakeMyClassAdmin,
