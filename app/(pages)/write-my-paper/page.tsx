...
const Page: FC<PageProps> = ({}) => {
  ...
  return (
    <MainLayout>
      <ProductSchema
        productTitle={MetaData.writeMyPaper.title}
        metaDescription={MetaData.writeMyPaper.description}
        pageUrl={`${baseUrl}/${MetaData.writeMyPaper.url}`}
      />
...
export function generateMetadata({}) {
  const baseUrl =
    process.env.NEXT_PUBLIC_SITE_URL || "https://scholarlyhelp.com/";
  const canonicalUrl = `${baseUrl}${MetaData.writeMyPaper.url}`;
  return {
    title: `${MetaData.writeMyPaper.title}`,
    description: `${MetaData.writeMyPaper.description}`,
