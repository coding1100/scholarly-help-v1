...
export function generateMetadata({}) {
  ...
  const canonicalUrl = `${baseUrl}${MetaData.homeOperationManagement.url}`;
  return {
    title: `${MetaData.homeOperationManagement.title}`,
    description: `${MetaData.homeOperationManagement.description}`,
    alternates: {
