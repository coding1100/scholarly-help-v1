...
export function generateMetadata({}) {
  ...
  const canonicalUrl = `${baseUrl}${MetaData.homeComputerScience.url}`;
  return {
    title: `${MetaData.homeComputerScience.title}`,
    description: `${MetaData.homeComputerScience.description}`,
    alternates: {
