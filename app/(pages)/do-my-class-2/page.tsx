...
const Page: FC<PageProps> = ({}) => {
  ...
  return (
    <MainLayout>
      <ProductSchema
        productTitle={MetaData.doMyClass2.title}
        metaDescription={MetaData.doMyClass2.description}
        pageUrl={`${baseUrl}/${MetaData.doMyClass2.url}`}
      />
...
export function generateMetadata({}) {
  const baseUrl =
    process.env.NEXT_PUBLIC_SITE_URL || "https://scholarlyhelp.com/";
  const canonicalUrl = `${baseUrl}${MetaData.doMyClass2.url}`;
  return {
    title: `${MetaData.doMyClass2.title}`,
    description: `${MetaData.doMyClass2.description}`,
