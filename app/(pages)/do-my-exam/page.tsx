...
const Page: FC<PageProps> = ({}) => {
  ...
  return (
    <MainLayout>
      <ProductSchema
        productTitle={MetaData.doMyExam.title}
        metaDescription={MetaData.doMyExam.description}
        pageUrl={`${baseUrl}/${MetaData.doMyExam.url}`}
      />
...
export function generateMetadata({}) {
  const baseUrl =
    process.env.NEXT_PUBLIC_SITE_URL || "https://scholarlyhelp.com/";
  const canonicalUrl = `${baseUrl}${MetaData.doMyExam.url}`;
  return {
    title: `${MetaData.doMyExam.title}`,
    description: `${MetaData.doMyExam.description}`,
