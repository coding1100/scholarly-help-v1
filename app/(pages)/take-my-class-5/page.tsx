...
// The clause after the em dash — the boldest claim in this headline ("even
// if you're failing") — is wrapped in the same orange span /take-my-class
// uses for its highlighted clause (text-[#F56200]), matching the -3 pattern.
const mainHeading = heroContent.mainHeading.replace(
  "—Even If You're Failing Right Now.",
  '—<span class="text-[#F56200]">Even If You\'re Failing Right Now.</span>',
);
