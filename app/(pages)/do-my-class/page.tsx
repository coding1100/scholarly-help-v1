...
const Page: FC<PageProps> = ({}) => {
  ...
  return (
    <MainLayout>
      <ProductSchema
        productTitle={MetaData.doMyClass.title}
        metaDescription={MetaData.doMyClass.description}
        pageUrl={`${baseUrl}/${MetaData.doMyClass.url}`}
      />
...
export function generateMetadata({}) {
  const baseUrl =
    process.env.NEXT_PUBLIC_SITE_URL || "https://scholarlyhelp.com/";
  const canonicalUrl = `${baseUrl}${MetaData.doMyClass.url}`;
  return {
    title: `${MetaData.doMyClass.title}`,
    description: `${MetaData.doMyClass.description}`,
