...
export function generateMetadata({}) {
  ...
  const canonicalUrl = `${baseUrl}${MetaData.assignOperationManagement.url}`;
  return {
    title: `${MetaData.assignOperationManagement.title}`,
    description: `${MetaData.assignOperationManagement.description}`,
    alternates: {
