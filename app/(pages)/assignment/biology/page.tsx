...
//   title: "Do My Biology Assignment | Biology Assignment Help | Scholarly Help",
// };
interface PageProps {}
...
export function generateMetadata({}) {
  ...
  const canonicalUrl = `${baseUrl}${MetaData.assignBiology.url}`;
  return {
    title: `${MetaData.assignBiology.title}`,
    description: `${MetaData.assignBiology.description}`,
    alternates: {
