...
//   title: "Seeking Anatomy Assignment Help | Do My Anatomy Assignment | Scholarly Help",
// };
interface PageProps {}
...
export function generateMetadata({}) {
  ...
  const canonicalUrl = `${baseUrl}${MetaData.assignAnatomy.url}`;
  return {
    title: `${MetaData.assignAnatomy.title}`,
    description: `${MetaData.assignAnatomy.description}`,
    alternates: {
