...
export function generateMetadata({}) {
  ...
  const canonicalUrl = `${baseUrl}${MetaData.assignOrganizationalBehavior.url}`;
  return {
    title: `${MetaData.assignOrganizationalBehavior.title}`,
    description: `${MetaData.assignOrganizationalBehavior.description}`,
    alternates: {
