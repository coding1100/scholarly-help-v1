...
export function generateMetadata({}) {
  ...
  const canonicalUrl = `${baseUrl}${MetaData.assignPharmachology.url}`;
  return {
    title: `${MetaData.assignPharmachology.title}`,
    description: `${MetaData.assignPharmachology.description}`,
    alternates: {
