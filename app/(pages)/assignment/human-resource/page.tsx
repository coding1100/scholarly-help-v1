...
export function generateMetadata({}) {
  ...
  const canonicalUrl = `${baseUrl}${MetaData.assignHumanResourse.url}`;
  return {
    title: `${MetaData.assignHumanResourse.title}`,
    description: `${MetaData.assignHumanResourse.description}`,
    alternates: {
