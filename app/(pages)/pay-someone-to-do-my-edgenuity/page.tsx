...
const Page: FC<PageProps> = ({}) => {
  ...
  return (
    <MainLayout>
      <ProductSchema
        productTitle={MetaData.paySomeoneToDoMyEdgenuity.title}
        metaDescription={MetaData.paySomeoneToDoMyEdgenuity.description}
        pageUrl={`${baseUrl}/${MetaData.paySomeoneToDoMyEdgenuity.url}`}
      />
...
export function generateMetadata({}) {
  const baseUrl =
    process.env.NEXT_PUBLIC_SITE_URL || "https://scholarlyhelp.com/";
  const canonicalUrl = `${baseUrl}${MetaData.paySomeoneToDoMyEdgenuity.url}`;
  return {
    title: `${MetaData.paySomeoneToDoMyEdgenuity.title}`,
    description: `${MetaData.paySomeoneToDoMyEdgenuity.description}`,
