...
export function generateMetadata({}) {
  ...
  const canonicalUrl = `${baseUrl}${MetaData.onlineComputerScience.url}`;
  return {
    title: `${MetaData.onlineComputerScience.title}`,
    description: `${MetaData.onlineComputerScience.description}`,
    alternates: {
