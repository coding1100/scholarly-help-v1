...
export function generateMetadata({}) {
  ...
  const canonicalUrl = `${baseUrl}${MetaData.examOperationManagement.url}`;
  return {
    title: `${MetaData.examOperationManagement.title}`,
    description: `${MetaData.examOperationManagement.description}`,
    alternates: {
