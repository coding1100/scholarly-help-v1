...
const PAGE_ID = "take-my-teas-exam";
...
export async function POST(request: NextRequest) {
  try {
    console.log(
      "POST /api/admin/take-my-teas-exam - Starting save operation",
    );
    ...
    const result = await db.collection("pages").replaceOne(query, dataToSave, {
      upsert: true,
    });
