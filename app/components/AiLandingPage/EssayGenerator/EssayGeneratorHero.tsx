...
import EssayGeneratorToolEmbed from "./EssayGeneratorToolEmbed";
import { heroContent } from "./content";

/**
 * Hero for the /tools/ai-essay-generator landing page: badge, headline, 3-step
 * indicator, the real essay generator tool embedded as a card, and the stats bar.
 ...
 * tool is client-rendered, inside EssayGeneratorToolEmbed.
 */
const EssayGeneratorHero: FC = () => (
...
export default EssayGeneratorHero;
