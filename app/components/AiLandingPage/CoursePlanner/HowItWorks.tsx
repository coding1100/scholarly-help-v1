...
import { howItWorksContent as c } from "./content";

/**
 * Dark 4-step card that overlaps the purple "Want a live dashboard" band
 * beneath it, matching the Grammar Checker landing page layering.
 */
const HowItWorks: FC = () => (
  <>
