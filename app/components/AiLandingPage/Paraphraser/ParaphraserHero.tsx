...
/**
 * Hero for the /ai-paraphraser landing page: badge, headline, 3-step
 * indicator, and the real paraphraser tool embedded as a card. The background
 * approximates the Figma illustration with soft blue washes.
 */
const ParaphraserHero: FC = () => {
  const [, setFlag] = useState(false);

  return (
    <section className="relative overflow-hidden bg-[linear-gradient(180deg,#EAF3FF_0%,#F2F9FF_55%,#F7FBFF_100%)]">
      {/* soft decorative washes standing in for the Figma 3D illustration */}
      <div
        aria-hidden
      ...
      <div className="relative mx-auto max-w-[1240px] px-4 pb-16 pt-10 text-center md:pb-20 md:pt-14">
        ...
        <div id="paraphraser-tool" className="mx-auto mt-10 max-w-[1180px] scroll-mt-24 text-left">
          <AIParaphraser setFlag={setFlag} variant="landing" />
        </div>
      </div>
    </section>
  );
...
export default ParaphraserHero;
