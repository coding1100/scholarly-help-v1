...
import { twoWaysContent as c } from "./content";
...
/** "Two ways to improve your writing" — free tool vs expert services columns. */
const TwoWays: FC = () => (
  <section className="bg-white py-16 md:py-20">
    <div className="mx-auto max-w-[1300px] px-4">
      ...
      <div className="mt-12 grid gap-8 lg:grid-cols-2">
        <div className="flex flex-col rounded-3xl bg-[#9F92EC] p-5 md:p-6">
          <h3 className="px-2 py-4 text-2xl font-semibold text-white md:text-3xl">
            {c.freeColumn.heading}
          </h3>
          <StepList steps={c.freeColumn.steps} />
        </div>
        <div className="flex flex-col rounded-3xl bg-primary-400 p-5 md:p-6">
          <h3 className="px-2 py-4 text-2xl font-semibold text-white md:text-3xl">
            {c.expertColumn.heading}
          </h3>
          <StepList steps={c.expertColumn.steps} />
        </div>
      </div>
    </div>
  </section>
