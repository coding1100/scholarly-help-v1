...
/**
 * Hero for the /tools/ai-grammar-check landing page: badge, headline, 3-step
 * indicator, the real grammar checker tool embedded as a card.
 * Mirrors HumanizerHero / ParaphraserHero exactly for pixel-matching.
 */
const GrammarCheckerHero: FC = () => (
...
export default GrammarCheckerHero;
