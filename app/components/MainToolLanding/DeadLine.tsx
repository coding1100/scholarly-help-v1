            ...
            <div className="w-full max-w-7xl container py-10 sm:py-14 lg:py-[70px] px-4 sm:px-8 lg:px-14 mx-auto flex flex-col items-center justify-center text-center">
                ...
                <div className="w-full max-w-xl sm:max-w-none flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4 px-2 sm:px-0">
                    <button
                        type="button"
                        onClick={() => {
                            const target = document.getElementById("pick-tools");
                            target?.scrollIntoView({ behavior: "smooth", block: "start" });
                        }}
                        className="w-full sm:w-auto bg-secondary-400 border border-secondary-400 text-white text-base sm:text-lg lg:text-xl font-medium py-3 sm:py-4 px-6 sm:px-7 rounded-md text-center"
                    >
                        Try a Free Tool
                    </button>
                    <button
                        ...
                        className="w-full sm:w-auto bg-transparent border border-white text-white text-base sm:text-lg lg:text-xl font-medium py-3 sm:py-4 px-6 sm:px-7 rounded-md text-center"
                    >
                        Talk To an Expert
                    </button>
                </div>
