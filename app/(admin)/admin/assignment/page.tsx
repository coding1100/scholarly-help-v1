...
export default function AssignmentAdmin() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Edit Assignment Content</h1>
        <p className="mt-2 text-sm text-gray-600">Manage the content displayed on the assignment page</p>
      </div>
