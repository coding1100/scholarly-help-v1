    ...
    const loadPage = async () => {
      ...
      try {
        ...
        setPageData(data && Object.keys(data).length > 0 ? {
          ...data,
          pageType: data.id || data.pageType || 'guarantee-anonymity'
        } : {
  ...
  const renderPageForm = () => {
    ...
    return (
      <form onSubmit={(e) => { e.preventDefault(); handlePageSave(); }} className="space-y-8">
        ...
        {/* Privacy Content */}
        <div className="bg-white shadow rounded-lg p-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-6">Privacy Content</h2>
          <div className="grid grid-cols-1 gap-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Main Heading</label>
              <input
            ...
            <div>
              ...
              {(pageData.privacyContent?.steps || []).map((step: any, index: number) => (
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    <div>
                      ...
                      <input
                        type="text"
                        value={step.title || ''}
                        onChange={(e) => updateArrayItem('privacyContent.steps', index, 'title', e.target.value)}
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={(e) => updateArrayItem('privacyContent.steps', index, 'description', e.target.value)}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm"
                      />
                    </div>
                  </div>
