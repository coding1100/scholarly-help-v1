...
const navigation = [
  ...
  { name: 'Edit Take My Class (Always Working Harder)', href: '/admin/take-my-class-always-working-harder', icon: HomeIcon },
  { name: 'Edit Take My Class (Saving Your Future)', href: '/admin/take-my-class-saving-your-future', icon: HomeIcon },
